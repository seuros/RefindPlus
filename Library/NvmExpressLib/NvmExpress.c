...
**/
EFI_STATUS EnumerateNvmeDevNamespace (
...
**/
EFI_STATUS DiscoverAllNamespaces (
    IN NVME_CONTROLLER_PRIVATE_DATA       *Private
) {
    EFI_STATUS                             Status;
    UINT32                                 NamespaceId;
...
**/
EFI_STATUS UnregisterNvmeNamespace (
...
**/
VOID EFIAPI ProcessAsyncTaskList (
    IN EFI_EVENT                    Event,
    IN VOID                        *Context
) {
...
**/
EFI_STATUS EFIAPI NvmExpressDriverBindingSupported (
    IN EFI_DRIVER_BINDING_PROTOCOL  *This,
    IN EFI_HANDLE                    Controller,
...
**/
EFI_STATUS EFIAPI NvmExpressDriverBindingStart (
    IN EFI_DRIVER_BINDING_PROTOCOL  *This,
    IN EFI_HANDLE                    Controller,
    IN EFI_DEVICE_PATH_PROTOCOL     *RemainingDevicePath
) {
...
**/
EFI_STATUS EFIAPI NvmExpressDriverBindingStop (
    IN  EFI_DRIVER_BINDING_PROTOCOL     *This,
    IN  EFI_HANDLE                       Controller,
...
**/
EFI_STATUS EFIAPI NvmExpressUnload (
    ...
    do {
        ...
        // It is because some of them are optionally installed based on
...
**/
EFI_STATUS EFIAPI NvmExpressLoad (
    IN EFI_HANDLE         ImageHandle,
