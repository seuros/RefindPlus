...
**/
EFI_STATUS EFIAPI NvmExpressDiskInfoInquiry (
...
**/
EFI_STATUS EFIAPI NvmExpressDiskInfoIdentify (
    IN     EFI_DISK_INFO_PROTOCOL   *This,
...
**/
EFI_STATUS EFIAPI NvmExpressDiskInfoSenseData (
    IN     EFI_DISK_INFO_PROTOCOL   *This,
...
**/
EFI_STATUS EFIAPI NvmExpressDiskInfoWhichIde (
    IN  EFI_DISK_INFO_PROTOCOL   *This,
