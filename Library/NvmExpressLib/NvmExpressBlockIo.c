...
EFI_STATUS AsyncReadSectors (
    ...
    do {
        ...
        // Create Event
        Status = gBS->CreateEvent(EVT_NOTIFY_SIGNAL, TPL_NOTIFY, AsyncIoCallback, Subtask, &Subtask->Event);
        if (EFI_ERROR(Status)) {
            break;
        }
    ...
    FREE_NVME_POOL(Command);
    FREE_NVME_POOL(CommandPacket);
...
**/
EFI_STATUS EFIAPI NvmeBlockIoReset (
...
**/
EFI_STATUS EFIAPI NvmeBlockIoReadBlocks (
    IN  EFI_BLOCK_IO_PROTOCOL   *This,
    IN  UINT32                   MediaId,
    IN  EFI_LBA                  Lba,
    IN  UINTN                    BufferSize,
...
**/
EFI_STATUS EFIAPI NvmeBlockIoWriteBlocks (
    IN  EFI_BLOCK_IO_PROTOCOL   *This,
    IN  UINT32                   MediaId,
    IN  EFI_LBA                  Lba,
    IN  UINTN                    BufferSize,
...
**/
EFI_STATUS EFIAPI NvmeBlockIoFlushBlocks (
    IN  EFI_BLOCK_IO_PROTOCOL   *This
) {
    NVME_DEVICE_PRIVATE_DATA         *Device;
    EFI_STATUS                        Status;
...
**/
EFI_STATUS EFIAPI NvmeBlockIoResetEx (
...
**/
EFI_STATUS EFIAPI NvmeBlockIoReadBlocksEx (
    IN     EFI_BLOCK_IO2_PROTOCOL *This,
    IN     UINT32                  MediaId,
    IN     EFI_LBA                 Lba,
...
**/
EFI_STATUS EFIAPI NvmeBlockIoWriteBlocksEx (
    IN     EFI_BLOCK_IO2_PROTOCOL  *This,
    IN     UINT32                   MediaId,
    IN     EFI_LBA                  Lba,
    IN OUT EFI_BLOCK_IO2_TOKEN     *Token,
...
**/
EFI_STATUS EFIAPI NvmeBlockIoFlushBlocksEx (
    IN     EFI_BLOCK_IO2_PROTOCOL   *This,
    IN OUT EFI_BLOCK_IO2_TOKEN      *Token
) {
    NVME_DEVICE_PRIVATE_DATA        *Device;
...
**/
EFI_STATUS TrustTransferNvmeDevice (
...
**/
EFI_STATUS EFIAPI NvmeStorageSecurityReceiveData (
...
**/
EFI_STATUS EFIAPI NvmeStorageSecuritySendData (
    IN EFI_STORAGE_SECURITY_COMMAND_PROTOCOL    *This,
    IN UINT32                                    MediaId,
    IN UINT64                                    Timeout,
    IN UINT8                                     SecurityProtocolId,
